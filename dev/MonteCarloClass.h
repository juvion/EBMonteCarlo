...
public:
    ...
    MonteCarloClass(char *Structure1_Filename, char* Structure2_Filename, int replicas, double temp, long seed=1, bool IsRNA=true);
	...
	MonteCarloClass(char *Restart_Filename, double temp, long seed=1, bool IsRNA=true);
	...
	double SpringEnergy(double sc_l, double sc_r, RNA *rna1, RNA *rna2, RNA *rna3);
...
private:
	...
	//An array to keep track of the spring constant of between each two images:
	double *springconst;	
